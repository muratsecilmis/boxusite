...
const accordionData = [
    {
        ...
        isOpen: true,
        content:
            "Local Game Jam, bizim dünyamızda gerçekleşen \"Local\" bir oyun geliştirme etkinliğidir."
    }, 
    {
        id: uuid(),
        ...
        isOpen: false,
        content:
            "Oyun dünyasına ilgili, başlangıç ve profesyonel seviyelerde herkes başvurabilir. Hikaye anlatmayı ve dinlemeye hazır olun!"
    },
    {
        id: uuid(),
        title: "Takım/Tek başvurabilir miyim",
        isOpen: false,
        content: "Evet bireysel veya takım olarak başvurabilirsiniz?"
    },
    {
        id: uuid(),
        title: "Bir başvuru koşulu var mı?",
        isOpen: false,
        content:
            "Etkinliğin kontenjanıyla alakalı olarak bir ön eleme yapmaktayız ama bu başvurmana etkilemesin, seni bekliyoruz! Unutma hepimiz bir yerden başladık, belki sende buradan başlayabilirsin"
    }
];
